/// osm.sol from https://github.com/makerdao/osm/blob/master/src/osm.sol
...
contract OSM is LibNote {
    ...
    /* the median contract address */
    address public src;
    uint16  constant ONE_HOUR = uint16(3600);
    /* time delay between poke calls */
    uint16  public hop = ONE_HOUR;
    /* time of last update, nearest multiple of hop */
    uint64  public zzz;
    ...
    /* current and next price value */
    Feed cur;
    Feed nxt;

    // Whitelisted contracts (price readers), set by an auth
    ...
    /* get the greatest multiple of hop right before ts */
    ...
    /* true if a new value can be updated */
    ...
    /* get cur price and get next price */
