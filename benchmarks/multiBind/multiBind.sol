...
contract DataReceiver is DataSender{
    ...
    slot Recv1(Package P_) {
		this.payGas(P_);
		if(code == 0){
			LocalDC0.Confirmed = P_.Data.Confirmed;
			LocalDC0.Deaths = P_.Data.Deaths;
			LocalDC0.Recovered = P_.Data.Recovered;
			LocalDC0.Active = P_.Data.Active;
		}else{
			LocalDC1.Confirmed = P_.Data.Confirmed;
			LocalDC1.Deaths = P_.Data.Deaths;
			LocalDC1.Recovered = P_.Data.Recovered;
			LocalDC1.Active = P_.Data.Active;
		}
    }
